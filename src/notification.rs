...
pub enum NotificationType {
    ...
    /// 好友请求被拒绝
    FriendRequestRejected { request_id: u64, user_id: u64 },

    /// 好友被删除
    FriendDeleted { user_id: u64, username: String },
...
impl NotificationMessage {
    ...
    pub fn generate_display_text_cn(notification_type: &NotificationType) -> String {
        match notification_type {
            ...
            NotificationType::GroupMemberKicked {
                username,
                kicker_name,
                reason,
                ..
            ...
            NotificationType::GroupNameChanged {
                old_name,
                new_name,
                changer_name,
                ..
                ...
                format!(
                    "{} 将群名称从「{}」改为「{}」",
                    changer_name, old_name, new_name
                )
            }
            NotificationType::GroupOwnerTransferred {
                old_owner_name,
                new_owner_name,
                ..
            } => {
            ...
            NotificationType::GroupAdminAdded {
                username,
                adder_name,
                ..
            } => {
            ...
            NotificationType::GroupMemberMuted {
                username,
                muter_name,
                duration_seconds,
                ..
            ...
            NotificationType::RedPacketSent {
                from_username,
                message,
                ..
            } => {
            ...
            NotificationType::RedPacketReceived {
                username, amount, ..
            } => {
                format!("{} 领取了红包（{:.2}元）", username, *amount as f64 / 100.0)
            }
            NotificationType::RedPacketEmpty { .. } => "红包已被抢完".to_string(),
